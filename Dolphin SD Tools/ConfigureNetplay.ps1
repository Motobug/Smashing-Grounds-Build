...
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit00.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit01.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit02.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit03.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit04.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit05.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit20.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit23.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit27.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit30.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit31.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit32.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit33.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit35.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit36.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/Dolphin ZSS Costume Files/FitSZerosuit37.pac" "../Build/Project+/pf/fighter/szerosuit" -Force -erroraction 'silentlycontinue'
